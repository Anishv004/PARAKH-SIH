...
############################################ Setup YOLO v3 ######################################################
lbl_file        = r'E:/trial/Intelligent-Online-Exam-Proctoring-System/Code/models/yolov3.txt'   #models/yolov3.txt'
classes         = open(lbl_file).read().strip().split("\n")
                                                                                                                      #give the correposnidn file path where the file is stored
yoloconfig      = r'E:/trial/Intelligent-Online-Exam-Proctoring-System/Code/models/yolov3.cfg'   #models/yolov3.cfg'
yoloweights     = r'E:/trial/Intelligent-Online-Exam-Proctoring-System/Code/models/yolov3.weights'   #models/yolov3.weights'
